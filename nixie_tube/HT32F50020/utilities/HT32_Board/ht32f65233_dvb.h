/*********************************************************************************************************//**
 * @file    ht32f65233_dvb.h
 * @version $Rev:: 8284         $
 * @date    $Date:: 2024-11-22 #$
 * @brief   The header file of HT32F65233 Development Board (temporary file, not finish/support yet).
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F65233_DVB_H
#define __HT32F65233_DVB_H
...
/** @addtogroup HT32F65233_DVB
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F65233_DVB_Exported_Constants HT32F65240 Development Board exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F65233_DVB_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F65233_DVB_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32F65233_DVB_BUZZER
  * @{
  */
...
/** @addtogroup HT32F65233_DVB_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32F65233_DVB_SPI_LCD
  * @{
  */
...
/** @addtogroup HT32F65233_DVB_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F65233_DVB_Exported_Functions HT32F65240 Development Board exported functions
  * @{
  */
